...
2. Зайдіть в папку Windows/dist та виберіть одну з розкладок.
...
1. Скачайте цей репозиторій ([як?](docs/download.png)) на свій комп'ютер.
2. Зайдіть в папку Mac/dist та відкрийте архів з розкладками (UkrainianTypographicLayouts.dmg).
